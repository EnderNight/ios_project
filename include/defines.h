 ...
 * Header dependent includes (if a function prototype needs <stdlib.h>, then
 * include it here)
 *
 * This means:
 * - no '#include' other than those required by the header (if, for example,
 * 'item.c' needs <stdlib> but 'item.h' doesn't, then include it in 'item.c')
